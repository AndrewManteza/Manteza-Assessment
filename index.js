...
app.get("/admindashboard",(req,res)=>{
    ...
    if(req.session.userid!=null){
        ...
        db.query(`
        SELECT applicationform.id, username,fname,lname,paddress,nationality,sex,birthdate,height,weight,civilstat,licenseclass,drivingskillaquired,highesteducational,bloodtype,organdonor,eyecolor,typeofapplication,fathername,mothername,spousename,emercontact,vehiclecat,conditions,userid,status,mname
